#include "CaligaAssetLoader.h"
#include "Assets/CaligaAssets.h"
...
using namespace Assets::Caliga;

namespace AssetLoaders
{

Caliga::Caliga( const World::Coordinates& coordinates, const String& name ) :
...
int Caliga::read( char* data, int offset, int len )
{
    if( m_data == nullptr )
    {
        // Not yet opened!
