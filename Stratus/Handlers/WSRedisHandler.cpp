...
Handler::Handler( EntropySource* entropySource,
                  ...
                  Linda2::TupleRoutes::Redis* redisTupleRoute,
  ...
  m_redisTupleRoute( redisTupleRoute ),
...
Handler::~Handler()
{
    ...
    m_redisTupleRoute->stop(); // Stops outgoing thread wait.
...
#endif
        m_redisTupleRoute->waitIncoming();
